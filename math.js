...
exports.psi2 =
  exports.psi =
  exports.millerLoop =
  exports.calcPairingPrecomputes =
  exports.isogenyMapG2 =
  exports.map_to_curve_simple_swu_9mod16 =
...
// Finite field over p.
class Fp {
  static ORDER = exports.CURVE.P;
  static MAX_BITS = bitLen(exports.CURVE.P);
  static ZERO = new Fp(0n);
  static ONE = new Fp(1n);
  value;
  constructor(value) {
...
class Fp2 {
  c0;
  c1;
  static ORDER = exports.CURVE.P2;
  static MAX_BITS = bitLen(exports.CURVE.P2);
  static ZERO = new Fp2(Fp.ZERO, Fp.ZERO);
  static ONE = new Fp2(Fp.ONE, Fp.ZERO);
  constructor(c0, c1) {
    this.c0 = c0;
    this.c1 = c1;
...
class Fp6 {
  ...
  c1;
  c2;
  static ZERO = new Fp6(Fp2.ZERO, Fp2.ZERO, Fp2.ZERO);
...
class Fp12 {
  c0;
  c1;
  static ZERO = new Fp12(Fp6.ZERO, Fp6.ZERO);
  static ONE = new Fp12(Fp6.ONE, Fp6.ZERO);
  static fromBigTwelve(t) {
    return new Fp12(
      Fp6.fromBigSix(t.slice(0, 6)),
      Fp6.fromBigSix(t.slice(6, 12))
    );
  }
  constructor(c0, c1) {
    this.c0 = c0;
